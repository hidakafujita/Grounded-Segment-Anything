...
RUN apt-get update && DEBIAN_FRONTEND=noninteractive apt-get install --no-install-recommends wget ffmpeg=7:* \
...
RUN python -m pip install --no-cache-dir -e GroundingDINO
